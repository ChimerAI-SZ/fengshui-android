...
class MapUiStateHolder {
    ...
    var sectorFallbackUsed by mutableStateOf(false)
    var sectorDebugAmapRaw by mutableStateOf(0)
    var sectorDebugGoogleRaw by mutableStateOf(0)
    var sectorDebugTypeFiltered by mutableStateOf(0)
    var sectorDebugSectorFiltered by mutableStateOf(0)
    var sectorDebugAmapStatus by mutableStateOf("-")
    var sectorDebugGoogleStatus by mutableStateOf("-")
